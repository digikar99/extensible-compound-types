...
(define-compound-type (pair :cl-type nil) (o &optional (type-a 'cl:*) (type-b 'cl:*))
...
(defmethod parametric-type-compile-time-lambda-body
  ...
  `(cl:lambda (elt-type)
     (destructuring-bind (&optional (type-a t) (type-b t))
         (if (listp elt-type)
             (rest elt-type)
             nil)
...
;;; If you are not running this interactively in SLIME, ALIVE, or SLIMV or the like,
;;; make sure that the above code is compiled before the below code begins to compile.
;;; Perhaps, surround the part below IN-PACKAGE in an
...
(disassemble (lambda (x y)
               ...
               (add-pair x y)))
; Check for the presence of ADDSS and ADDSD instructions below
; disassembly for (COMMON-LISP:LAMBDA (X Y))
; Size: 219 bytes. Origin: #x538F5BBF                         ; (COMMON-LISP:LAMBDA
                                                                    (X Y))
; BBF:       488B4205         MOV RAX, [RDX+5]
; BC3:       3C19             CMP AL, 25
; BC5:       0F85B5000000     JNE L7
; BCB:       66480F6EC8       MOVQ XMM1, RAX
; BD0:       0FC6C9FD         SHUFPS XMM1, XMM1, #4r3331
; BD4:       488B4705         MOV RAX, [RDI+5]
; BD8:       3C19             CMP AL, 25
; BDA:       0F859D000000     JNE L6
; BE0:       66480F6ED8       MOVQ XMM3, RAX
; BE5:       0FC6DBFD         SHUFPS XMM3, XMM3, #4r3331
; BE9:       F30F58D9         ADDSS XMM3, XMM1
; BED:       488B4A0D         MOV RCX, [RDX+13]
; BF1:       488D41F1         LEA RAX, [RCX-15]
; BF5:       A80F             TEST AL, 15
; BF7:       7503             JNE L0
; BF9:       80381D           CMP BYTE PTR [RAX], 29
; BFC: L0:   757C             JNE L5
; BFE:       F20F1049F9       MOVSD XMM1, [RCX-7]
; C03:       488B4F0D         MOV RCX, [RDI+13]
; C07:       488D41F1         LEA RAX, [RCX-15]
; C0B:       A80F             TEST AL, 15
; C0D:       7503             JNE L1
; C0F:       80381D           CMP BYTE PTR [RAX], 29
; C12: L1:   7563             JNE L4
; C14:       F20F1051F9       MOVSD XMM2, [RCX-7]
; C19:       F20F58D1         ADDSD XMM2, XMM1
; C1D:       BADFEE2250       MOV EDX, #x5022EEDF             ; ':A
; C22:       660F7EDF         MOVD EDI, XMM3
; C26:       48C1E720         SHL RDI, 32
; C2A:       4080CF19         OR DIL, 25
; C2E:       BE3FEC2250       MOV ESI, #x5022EC3F             ; ':B
; C33:       4D896D28         MOV [R13+40], R13               ; thread.pseudo-atomic-bits
; C37:       498B4570         MOV RAX, [R13+112]              ; thread.mixed-tlab
; C3B:       4883C010         ADD RAX, 16
; C3F:       493B4578         CMP RAX, [R13+120]
; C43:       7749             JNBE L9
; C45:       49894570         MOV [R13+112], RAX              ; thread.mixed-tlab
; C49:       4883C0FF         ADD RAX, -1
; C4D: L2:   66C740F11D01     MOV WORD PTR [RAX-15], 285
; C53:       4D316D28         XOR [R13+40], R13               ; thread.pseudo-atomic-bits
; C57:       7402             JEQ L3
; C59:       CC09             INT3 9                          ; pending interrupt trap
; C5B: L3:   F20F1150F9       MOVSD [RAX-7], XMM2
; C60:       488945F0         MOV [RBP-16], RAX
; C64:       488B5DF0         MOV RBX, [RBP-16]
; C68:       B908000000       MOV ECX, 8
; C6D:       FF7508           PUSH QWORD PTR [RBP+8]
; C70:       B8222F4B50       MOV EAX, #x504B2F22             ; #<FDEFN MAKE-PAIR>
; C75:       FFE0             JMP RAX
; C77: L4:   CC50             INT3 80                         ; OBJECT-NOT-DOUBLE-FLOAT-ERROR
; C79:       04               BYTE #X04                       ; RCX(d)
; C7A: L5:   CC50             INT3 80                         ; OBJECT-NOT-DOUBLE-FLOAT-ERROR
; C7C:       04               BYTE #X04                       ; RCX(d)
; C7D: L6:   CC4F             INT3 79                         ; OBJECT-NOT-SINGLE-FLOAT-ERROR
; C7F:       00               BYTE #X00                       ; RAX(d)
; C80: L7:   CC4F             INT3 79                         ; OBJECT-NOT-SINGLE-FLOAT-ERROR
; C82:       00               BYTE #X00                       ; RAX(d)
; C83: L8:   FF24256800A052   JMP QWORD PTR [#x52A00068]      ; SB-VM::ALLOC-TRAMP
; C8A:       CC10             INT3 16                         ; Invalid argument count trap
; C8C:       CC10             INT3 16                         ; Invalid argument count trap
; C8E: L9:   6A10             PUSH 16
; C90:       E8EEFFFFFF       CALL L8
; C95:       58               POP RAX
; C96:       0C0F             OR AL, 15
; C98:       EBB3             JMP L2
#+END_SRC
